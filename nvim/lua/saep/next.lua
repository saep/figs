...
local nextActions = {
  ...
  qf = {
    ...
    next = function() vim.api.nvim_command("cnext") end,
    prev = function() vim.api.nvim_command("cprevious") end,
  ...
  loclist = {
    ...
    next = function() vim.api.nvim_command("lnext") end,
    prev = function() vim.api.nvim_command("lprevious") end,
    close = function()
      vim.fn.getloclist(0)
  ...
  scroll = {
    ...
    next = function() send_keys("<C-d>") end,
    prev = function() send_keys("<C-u>") end,
    canBeExecuted = function()
      return true
    end,
  },
